...
$consulta = "INSERT into registro (nombre,cedula,curso,nivel,fecha,rol) VALUES ('$nombre','$cedula','$curso','$nivel','$fecha','$rol')";
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                            ...
                            <h2 style="font-weight: bold;" class="text-center text-white">Registrar al curso:</h2>
                          ...
                          <div class="form-group">
                                  <label style="font-weight: bold;" for="fecha" class="form-label text-white">Fecha de ingreso:</label>
